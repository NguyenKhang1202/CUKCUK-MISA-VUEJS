    ...
    <div class="content-filter">
      ...
      <div class="filter-right">
        <button
          @click="onClickDelete"
          id="btnDelete"
          class="m-btn-bg btn-delete disabled"
        ...
        <button
          id="btnRefresh"
          class="m-btn-bg refresh-icon btn-refresh"
        >
        </button>
      </div>
    </div>
        ...
        <tbody v-show="!isShowLoading">
          ...
          <div>
            <tr
              ...
              v-bind:class="{
                selectedRow: this.employeeSelected.EmployeeId == employee.EmployeeId,
              }"
            ...
            >
              ...
              <td style="width: 50px">{{ getValueEnum(employee.Gender, "Gender") }}</td>
...
#btnDelete.disabled, .disabled:hover {
